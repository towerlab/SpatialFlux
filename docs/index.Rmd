...
## Attention
Despite support for 10x genomics Visium HD protocol, SpatialFlux calculation might take considerable computing time and resources due to true single cell resolution datasets size and complexity. In these cases we highly recommend having at disposal at least 8 CPU cores and 64gb RAM.
